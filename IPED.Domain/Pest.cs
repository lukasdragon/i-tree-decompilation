...
namespace IPED.Domain
{
  public class Pest
  {
    [LocalizedDescription(typeof (Resources), "Pest_Id")]
    public virtual int Id { get; set; }

    [LocalizedDescription(typeof (Resources), "Pest_CommonName")]
    public virtual string CommonName { get; set; }

    [LocalizedDescription(typeof (Resources), "Pest_ScientificName")]
