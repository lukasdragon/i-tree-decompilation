...
// Type: EcoIpedReportGenerator.PestSignSymptomDetailsSummarybyLandusesRG
...
{
  internal class PestSignSymptomDetailsSummarybyLandusesRG : ReportGenerator, IBindable
  {
    ...
    public PestSignSymptomDetailsSummarybyLandusesRG()
    {
    ...
    {
      PestSignSymptomDetailsSummarybyLanduses summarybyLanduses = new PestSignSymptomDetailsSummarybyLanduses(Convert.ToInt16(this.m_bindings[0].Value), staticData.IsSample);
      C1PrintDocument c1PrintDocument = new C1PrintDocument();
      C1PrintDocument C1doc = c1PrintDocument;
      summarybyLanduses.RenderBody(C1doc, (Graphics) null);
