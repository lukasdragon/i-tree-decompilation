...
// Type: i_Tree_Eco_v6.Reports.IndividualTreeOxygenProduction
...
{
  public class IndividualTreeOxygenProduction : DatabaseReport
  {
    public IndividualTreeOxygenProduction()
    {
      this.ReportTitle = i_Tree_Eco_v6.Resources.Strings.ReportTitleOxygenProductionByMeasuredTrees;
    ...
    {
      DataTable dataTable = this.curInputISession.GetNamedQuery(nameof (IndividualTreeOxygenProduction)).SetParameter<Guid>("y", this.YearGuid).SetResultTransformer((IResultTransformer) new DataTableResultTransformer()).UniqueResult<DataTable>();
      if (dataTable == null)
      {
      ...
      else
      {
        ...
        renderTable.Cols[0].Style.TextAlignHorz = renderTable.Cols[1].Style.TextAlignHorz = renderTable.Cols[2].Style.TextAlignHorz = renderTable.Cols[6].Style.TextAlignHorz = renderTable.Cols[7].Style.TextAlignHorz = AlignHorzEnum.Left;
        ...
        renderTable.Cells[0, 3].Text = i_Tree_Eco_v6.Resources.Strings.OxygenProduction;
        renderTable.Cells[1, 3].Text = ReportUtil.GetFormattedValuePerYrStr(ReportBase.KgUnits());
        renderTable.Cells[0, 4].Text = i_Tree_Eco_v6.Resources.Strings.xCoordinate;
        renderTable.Cells[0, 5].Text = i_Tree_Eco_v6.Resources.Strings.yCoordinate;
        renderTable.Cells[0, 6].Text = i_Tree_Eco_v6.Resources.Strings.Comments;
        renderTable.Cells[0, 7].Text = i_Tree_Eco_v6.Resources.Strings.UserID;
        renderTable.Cols[0].Visible = ReportBase.plotInventory;
        renderTable.Cols[4].Visible = renderTable.Cols[5].Visible = this.hasCoordinates && ReportBase.m_ps.ShowGPS;
        renderTable.Cols[6].Visible = ReportBase.m_ps.ShowComments;
        renderTable.Cols[7].Visible = this.hasUID && ReportBase.m_ps.ShowUID;
    ...
    public override List<ColumnFormat> ColumnsFormat(DataTable data)
    {
      ...
      columnFormatList.Add(new ColumnFormat()
      {
        HeaderText = ReportUtil.FormatInlineCSVHeaderWUnitsStr(i_Tree_Eco_v6.Resources.Strings.OxygenProduction, ReportUtil.GetValuePerYrStr(ReportBase.KgUnits())),
