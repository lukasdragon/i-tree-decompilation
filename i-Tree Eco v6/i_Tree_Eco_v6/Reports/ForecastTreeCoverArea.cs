...
// Type: i_Tree_Eco_v6.Reports.ForecastTreeCoverArea
...
{
  public class ForecastTreeCoverArea : ForecastSimpleReport
  {
    public ForecastTreeCoverArea()
    {
      this.ReportTitle = i_Tree_Eco_v6.Resources.Strings.ReportTitleTreeCoverOverTime;
    ...
    public override void InitDocument(C1PrintDocument C1doc)
    {
      ...
      {
        this.dataValueHeading = ReportUtil.FormatInlineHeaderUnitsStr(i_Tree_Eco_v6.Resources.Strings.TotalTreeCover, ReportBase.HaUnits());
      ...
      {
        this.dataValueHeading = ReportUtil.FormatInlineHeaderUnitsStr(i_Tree_Eco_v6.Resources.Strings.TotalTreeCover, this.SquareMeterUnits());
