...
// Type: i_Tree_Eco_v6.Reports.AllPlots
...
{
  public class AllPlots : PlotCommon
  {
    public AllPlots() => this.ReportTitle = Strings.ReportTitleAllPlots;
