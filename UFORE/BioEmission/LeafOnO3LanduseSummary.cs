...
// Type: UFORE.BioEmission.LeafOnO3LanduseSummary
...
{
  internal class LeafOnO3LanduseSummary
  {
      ...
      OleDbConnection cnBioEDB)
    {
      ...
      Formation.ReadLeafOnO3FormationRecords(cnBioEDB, ref formationList);
      LeafOnO3LanduseSummary o3LanduseSummary = new LeafOnO3LanduseSummary();
